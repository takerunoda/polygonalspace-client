...
import EnableGoogleSigninComponent from '../Components/EnableGoogleSigninComponent'

const EnableGoogleSignin = ({ headObject, siteUrl, baseName, twitterID, MyName } : PageProps) => {

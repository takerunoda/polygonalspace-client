...
import EnablePasswordSigninComponent from '../Components/EnablePasswordSigninComponent'

const EnablePasswordSignin = ({ headObject, siteUrl, baseName, twitterID, MyName } : PageProps) => {

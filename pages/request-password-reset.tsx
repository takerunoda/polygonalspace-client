...
import RequestRasswordResetComponent from '../Components/RequestRasswordResetComponent';
import { useRedirectToHomeLoggedin } from '../utils/useRedirectToHome';
import { defaultPicture, headData } from '../utils/headData';

const RequestPasswordReset = ({ headObject, siteUrl, baseName, twitterID, MyName } : PageProps) => {
    const {userState: {isLoggedin}} = useUserContext();
    useRedirectToHomeLoggedin()

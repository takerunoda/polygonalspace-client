...
import { send_category_posts_by_page, send_user_posts_by_page } from './urls';

interface FunctionProps {
        userId: string
}

export const getInitialMemoUser = async ({userId} : FunctionProps) => {                
                const inputData = { currentPage: 1, userId}

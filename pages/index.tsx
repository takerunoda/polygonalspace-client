...
const Index = ({headObject} : HeadProps) => {
    const userContext = useUserContext()
    if ( !userContext ) {
      return null
    }
    const { isLoggedin, accessToken, loginType } = userContext;
    ...
    <>
      ...
      <main>
        ...
        <div className="pb-16 sm:pb-16">
          ...
          <div className="text-base md:text-xl leading-relaxed">
            <h3 className="leading-relaxed">
            <Language jp={<><a href="" className="text-blue-500 hover:underline font-bold">NASA 画像ライブラリー</a>とは、NASA (アメリカ航空宇宙局) が無料で公開している画像ライブラリーです。望遠鏡や探査機によって撮影された画像を、所定の<a className="text-blue-500 hover:underline font-bold" target="_blank" href={urlNASAMedia} >NASAメディア利用規定</a>のもとで利用することができます。また、NASAはアプリ開発者向けに画像ライブラリーにアクセスするための <a href="" className="text-blue-500 hover:underline font-bold">API</a> (Application Programming Interface) を提供しています。当サイトは、このNASA APIを利用して、画像ライブラリーからデータを取得・表示しています。</>} en={<><a href={urlNASAImageLibrary} className="text-blue-500 hover:underline font-bold">NASA Image and Video Library</a> is a public library which everyone can access for images and videoes taken by telescopes and spacecrafts under <a className="text-blue-500 hover:underline font-bold" target="_blank" href={urlNASAMedia} >Media Usage Guidelines</a>. This website uses the NASA's <a href="" className="text-blue-500 hover:underline font-bold">API</a> (Application Programming Interface). The API is provided for software engineers who build apps to retrieve images and text data from the library.</>} />
            </h3>
          </div>
        </div>
      <div className="pb-16 sm:pb-16">
          <h2 className="indexH2">
                         <ul className="flex justify-center hover:text-green-400">
            ...
            <h3>
              <ul className="mx-auto text-lg sm:text-2xl text-purple-500 text-center font-bold leading-relaxed my-6 sm:my-10 w-72 sm:w-96">
                <Language jp={<><li>日本語のキーワードを選んで</li>
                <li className="my-2">NASAの宇宙画像を検索</li>
                {/* <li>お気に入りをブックマークできます</li> */}
                </>
                } 
                en={<><li>Choose Keywords to Search for</li>
                <li className="my-2">NASA Space Images</li>
            ...
            <div>
              <h3 className="w-10/12 mx-auto text-lg sm:text-2xl text-blue-500 font-bold my-3 sm:my-6 text-center leading-relaxed">
                <ul>
                  ...
                  <li className="stepTitleIndex"><Language jp={<ul><li>お気に入りを</li><li>ブックマーク</li></ul>} en={"Bookmark Your Favorites"} /></li>
                </ul>
              </h3>
              <h4 className="leading-relaxed">
        ...
        <div className="pb-16 sm:pb-16">
          <h2 className="indexH2">
            ...
            <div className="text-base md:text-xl leading-relaxed">
              <h3 className="leading-relaxed">
              <Language jp={<><span className="text-blue-500 hover:underline font-bold"><Link href="/shared-bookmarks">「共有ブックマーク」</Link></span>ページでは、1人以上のユーザーにブックマークされた画像記事の一部を紹介しています。共有ブックマークのアイテムもブックマークすることが可能です。</>} en={<><span className="text-blue-500 hover:underline font-bold"><Link href="/shared-bookmarks">"Shared Bookmark"</Link></span> page displays some images and videos which are bookmarked by at least one user. You can bookmark items in Shared Bookmark list.</>} />
              </h3>
            </div>
        </div>
        <div className="pb-16 sm:pb-16">
          <h2 className="indexH2">
            ...
            <h3 className="text-base md:text-xl leading-relaxed">
              ...
              <Language jp={<><span className="text-blue-500 hover:underline font-bold"><Link href="/posts">「投稿」</Link></span>ページでは、NASAの画像記事をベースにして作成された投稿記事を表示しています。記事の要約・日本語訳が中心です。Polygonal Spaceで許可されたユーザーだけが投稿可能となっています。</>} en={<><span className="text-blue-500 hover:underline font-bold"><Link href="/posts">"Posts"</Link></span> page displays  articles which are created based on NASA's original articles, mostly summary or translation articles (in Japanese). Only the permitted users are eligible to post an article.</>} />
              </p>
            </h3>
        </div>
        <div className="pb-16 sm:pb-16">
          <h2 className="indexH2">
                      ...
                      {!isLoggedin ? <Link href="/guest-login">
                           <li className={`cursor-pointer hover:underline`}>
            ...
            <h3>
              <ul className="mx-auto text-lg sm:text-2xl text-purple-500 text-center font-bold leading-relaxed my-6 sm:my-10 w-72 sm:w-96">
                <Language jp={<><li>アカウントユーザーが利用する機能を試すことができます。</li><li>[ 登録不要 ]</li></>} en={<><li>Try App Features</li>
                <li>Before Signup</li></>} />
              </ul>
            </h3>
              ...
              (<ul className="">
                ...
                <ul className="">
                  <li className="text-4xl sm:text-4xl mb-2 text-blue-500">
                    ...
                    <li className="text-center hover:underline w-72 sm:w-80 mx-auto cursor-pointer">
                    <Language jp={"1. パスワードを設定して登録 "} en={"1. Set Password"} />
                    </li>
                  </Link>
                  </ul>
                ...
                (
                   <ul className="">
                    <li className="text-4xl sm:text-4xl mb-2 text-blue-500">
                     ...
                     <li className="text-center">
                      <Language jp={"2. Google認証で登録"} en={<><li className="text-center">
                      2. Sign up with
                     </li>
                     <li className="text-center">
      ...
      <div className="pb-8 sm:pb-8">
          <h2 className="h2">
          <Language jp={<ul><li>このサイトで</li>
          <li>使用されている技術</li></ul>} en={<ul><li>Technologies</li>
          <li>used in this app</li></ul>} />
        </h2>
        <div className="md:text-xl leading-relaxed">
          <ul className="flex flex-wrap justify-center leading-loose">
            <li className="mb-3 mt-3 sm:mb-6 sm:mt-4 px-10 w-64">
              ...
              <ul className="flex justify-center">
                <li className=" text-center">
                  ...
                  <div className="ml-2">
                    <h3><a className="text-blue-500 hover:text-red-500" target="_blank" href={urlReact}>React</a> (<a className="text-blue-500 hover:text-red-500" target="_blank" href={urlNextjs}>Next.js</a>)</h3>
                    <h3><a className="text-blue-500 hover:text-red-500" target="_blank" href={urlTailwind}>tailwindcss</a></h3>
                  </div>
                </li>
              </ul>
            </li>
            <li className="mb-3 mt-3 sm:mb-6 sm:mt-6 px-10 w-64">
              <ul className="flex justify-center mb-2">
              ...
              <ul className="text-center">
                ...
                <li>
                  <h3>
                    <a className="text-blue-500 hover:text-red-500" target="_blank" href={urlNodejs}>Node.js</a> 
                  </h3>
                  <h3>
                    <a className="text-blue-500 hover:text-red-500" target="_blank" href={urlExpress}>Express</a>
                  </h3>
                </li>
              </ul>
            </li>
            <li className="mb-3 mt-3 sm:mb-6 sm:mt-6 px-10 w-64">
              <ul className="flex justify-center">
                <li className="text-3xl text-blue-500 mb-2"><SiMongodb /></li>
              </ul>
              <ul className="text-center">
                <li>
                  <h3>
                ...
                <li>
                  <h3>
                    <a className="text-blue-500 hover:text-red-500" target="_blank" href={urlMongoDB}>MongoDB</a>
                  </h3>
                </li>
              </ul>
            </li>
            <li className="mb-3 mt-3 sm:mb-6 sm:mt-6 px-10 w-64">
              <ul className="flex justify-center mb-2">
                <li className="text-3xl text-blue-500"><SiTypescript /></li>
              </ul>
              <ul className="text-center">
                <li>
                  <h3>
                ...
                <li>
                  <h3>
                    <a className="text-blue-500 hover:text-red-500" target="_blank" href={urlTypescript}>TypeScript</a>
                  </h3>
                </li>
              </ul>
            </li>
      ...
      <div className="pb-8 sm:pb-8">
          ...
          <div className="md:text-xl leading-relaxed">
                ...
                <ul className="flex justify-between w-48 mx-auto">
                  <li>
                    <p className="text-blue-500 hover:text-red-500"><a target="_blank" href={process.env.NEXT_PUBLIC_GITHUB_CLIENT}>Client</a></p>
                  </li>
                  <li>
                    <p className="text-blue-500 hover:text-red-500"><a target="_blank" href={process.env.NEXT_PUBLIC_GITHUB_SERVER}>Server</a></p>
                  </li>
                </ul>
          </div>      
        </div>
      <div className="pb-16 sm:pb-16">
          ...
          <div className="md:text-xl leading-relaxed text-center">
              <p className="text-blue-500 hover:text-purple-500 mb-3">
                {process.env.NEXT_PUBLIC_MYNAME}
              </p>

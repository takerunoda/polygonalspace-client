...
import { defaultPicture } from '../utils/headData'
...
const HeadItemBlog = ({postData, slug, siteUrl, baseName, twitterID, MyName} : ComponentProps) => {
    const imageUrl = postData ? postData.feature_image : defaultPicture
    const title = postData.meta_title ?? postData.title
    const description = postData.meta_description ?? trimArticleMeta(postData.html.toString())
    const schema = {

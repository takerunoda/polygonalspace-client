...
import DeleteAccountGoogleComponent from '../Components/DeleteAccountGoogleComponent';
import { defaultPicture, headData } from '../utils/headData';

const DeleteAccountGoogle = ({ headObject, siteUrl, baseName, twitterID, MyName } : PageProps) => {       

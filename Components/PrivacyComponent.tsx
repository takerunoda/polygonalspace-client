...
const PrivacyComponent = () => {
  ...
  const breadcrumb_2 = { name: `プライバシーポリシー`, name_EN: `Privacy Policy`, url: `/privacy-policy`}
          ...
          <h1 className="h1"><Language jp={"プライバシーポリシー"} en={"Privacy Policy"} /></h1>
           <h2 className="privacyH2">
              ...
              <ul　className="sm:ml-10 mt-3 font-bold mb-8 sm:mb-12 ">
                ...
                <h3 className="text-lg sm:text-2xl font-bold mt-4 sm:mt-8 mb-5 sm:mb-8 text-left indent">
                  <Language jp={<ul><li>1. ユーザーから送信されるデータ</li></ul>} en={`1. Data submitted by user`} />
                </h3>
              ...
              <div className="privacyH2">
                <h2 className="h2">
                  ...
                  <p className="privacyParagraph"><Language jp={<>Googleアナリティクスによるユーザー情報の収集については、<span className="text-blue-500 cursor-pointer hover:underline font-bold"><a href={urlGoogleTOS} target="_blank" rel="noreferrer">Googleアナリティクス利用規約</a></span>及び the <span className="text-blue-500 cursor-pointer hover:underline font-bold"><a href={urlGooglePrivacy} target="_blank" rel="noreferrer">Googleプライバシーポリシー</a></span>に規定に基づいて制限されています。当サイトの利用者は、Googleアナリティクスによるユーザー識別を希望しない場合は、ブラウザのクッキー機能を停止することで、Googleアナリティクスのユーザー識別を機能させないようにすることができます。</>} en={<>Google’s ability to use and share information collected by Google Analytics about your visits to this website is restricted by the <span className="text-blue-500 cursor-pointer hover:underline font-bold"><a href={urlGoogleTOS} target="_blank" rel="noreferrer">Google Analytics Terms of Use</a></span> and the <span className="text-blue-500 cursor-pointer hover:underline font-bold"><a href={urlGooglePrivacy} target="_blank" rel="noreferrer">Google Privacy Policy</a></span>. You can prevent Google Analytics from recognizing you on return visits to this website by disabling cookies on your browser.</>} /></p>
              </div>
              <div className="privacyH2">
                <h2 className="h2">
